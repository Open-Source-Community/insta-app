...
//            updateLikesCounter(holder, holder.getFeedItem().getLikes().getCounter());
...
//
//        ObjectAnimator rotationAnim = ObjectAnimator.ofFloat(holder.item_post_btn_like, "rotation", 0f, 360f);
//        rotationAnim.setDuration(300);
//        rotationAnim.setInterpolator(ACCELERATE_INTERPOLATOR);
//
//        ObjectAnimator bounceAnimX = ObjectAnimator.ofFloat(holder.item_post_btn_like, "scaleX", 0.2f, 1f);
//        bounceAnimX.setDuration(300);
//        bounceAnimX.setInterpolator(OVERSHOOT_INTERPOLATOR);
//
//        ObjectAnimator bounceAnimY = ObjectAnimator.ofFloat(holder.item_post_btn_like, "scaleY", 0.2f, 1f);
//        bounceAnimY.setDuration(300);
//        bounceAnimY.setInterpolator(OVERSHOOT_INTERPOLATOR);
//        bounceAnimY.addListener(new AnimatorListenerAdapter() {
//            @Override
//            public void onAnimationStart(Animator animation) {
//                holder.item_post_btn_like.setImageResource(R.drawable.ic_heart_red);
//            }
//
//            @Override
//            public void onAnimationEnd(Animator animation) {
